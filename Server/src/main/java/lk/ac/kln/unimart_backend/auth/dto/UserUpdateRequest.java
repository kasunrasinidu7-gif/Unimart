...
public class UserUpdateRequest {
    ...
    @NotNull(message = "Email verification flag is required")
    private Boolean emailVerified;

    public UserUpdateRequest() {
    }

    public UserUpdateRequest(String universityEmail, String passwordHash, String fullName, UserRole role, Boolean emailVerified) {
